<#
Package a completed Mega Man X3 Windows release build.
...
without its SDL runtime and the recomp-ui assets/ next to it):
  ...
  MegaManX3SNESRecomp-windows-x64-v<Version>.zip
...
# 0.10.0` to `0`, which is exactly how that happens in practice â€” always pass
