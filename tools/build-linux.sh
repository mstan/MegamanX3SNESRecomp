...
# ============================ PER-GAME CONFIG ===============================
APP_NAME="MegaManX3"
RELEASE_SLUG="MegaManX3SNESRecomp"        # matches the windows zip prefix
CMAKE_TARGET="MegaManX3SNESRecomp"
ROM_EXTS="sfc smc"
EXTRA_ARGS=""
...
REQUIRED_MOD_MANIFESTS=(
  "packages/megaman-x3.enhancement.widescreen/1.0.0/manifest.toml"
)
